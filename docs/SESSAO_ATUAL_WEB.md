...
**Próximo passo imediato:** próximos itens pré-deploy do `PLANO_EXECUCAO_WEB.md` conforme priorização. (Follow-up opcional fora deste batch: o desktop ainda usa `↕` para Transações — mesmo destoante, se desejado trocar por `⇄` também.)
